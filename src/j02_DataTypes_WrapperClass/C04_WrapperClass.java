...
public class C04_WrapperClass {
    ...
    // ara çözüm imkanı sunmuştur.
     ...
     String tc="1234455";
     String id= "98765";
     System.out.println(tc+id);//concat : birleştirme : 12345598765

     int yeniTC = Integer.valueOf(tc);// tc String değerini int çevirdi yeni Tc ye atadı
        System.out.println("yeniTC = " + yeniTC);

        int yeniId = Integer.valueOf(id);// tc String değerini int çevirdi yeni Tc ye atadı
        System.out.println("yeniId = " + yeniId);

        System.out.println(yeniId+yeniTC);// aritmetik toplam : 1333220
        String okulNo="23453l";
