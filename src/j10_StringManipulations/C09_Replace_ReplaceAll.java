...
public class C09_Replace_ReplaceAll {
    public static void main(String[] args) {
         ...
         */
        System.out.println(str.replaceFirst("a", "@"));//sadece ilk a yı @yaptı : j@vaCAN'lara selam olsun java ile bolcana offer
...
//
        ...
        String isim ="Çigdem";
        String soyad="Şen";
        String Kartno="1234567890123456L";
        String yeniisim =isim.charAt(0)+isim.substring(1).replaceAll("\\w","*");
        String soyisim =soyad.charAt(0)+soyad.substring(1).replaceAll("\\w","*");


        String yenikartno="**** **** **** ****" +Kartno.substring(12);

        System.out.println("isim-soyisim:"+yeniisim+""+soyisim+"kart no :"+yenikartno);
