 ...
 */
 ...
 String str2 =  "merhaba ";
        ...
        String s1="songul hanım"; // String pool : gömlek cebi : kolay cıkan para
        String s2="songul hanım"; // String pool : gömlek cebi : kolay cıkan para
        String s3=new String("songul hanım");// abj non primitive : heap memory: cüzdan
        String s4=new String("songul hanım");// abj non primitive : heap memory: cüzdan
